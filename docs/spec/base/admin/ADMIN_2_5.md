...
| WEKO3カスタム語彙                          | 対応するTSV項目名    | 必須 | バリュータイプ     | デフォルト値 | 親エンティティタイプ | 説明                     |
| ------------------------------------------ | -------------------- | :--: | ------------------ | ------------ | -------------------- | ------------------------ |
| wk:index                                   | .IndexID[0]          |  〇  | 配列               | -            | Dataset              | インデックスID           |
| wk:publishStatus                           | .PUBLISH_STATUS      |  〇  | 文字列             | -            | Dataset              | 公開ステータス           |
| wk:feedbackMail                            | .FEEDBACK_MAIL[0]    |  -   | 文字列             | -            | Dataset              | フィードバックメール     |
...
| wk:requestMail                             | -                    |  -   | 文字列             | -            | Dataset              | リクエストメール         |
