...
> 1000,123
  ...
  - コンテンツファイルが無く、本文URLの情報もない、または、「show List」の設定がない場合、  
    「Files」の項目が表示されるが、項目がグレーアウトされ、押下できなくなる。  

  - メタデータ「Description」の情報があり、「show List」の設定もある場合、  
    「Description」の項目を押下することで、  
     項目下部にDescription情報が表示される。

  - メタデータ「Description」の情報がない、または「show List」の設定がない場合、  
    「Description」の項目がグレーアウトされ、押下できなくなる。

  - メタデータ「Relation」の情報があり「show List」の設定もある場合、  
    「References」の項目を押下することで、  
     項目下部にRelation情報が表示される。

  - メタデータ「Relation」の情報がない、または「show List」の設定がない場合、  
