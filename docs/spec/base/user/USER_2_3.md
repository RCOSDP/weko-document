...
- 登録された雑誌情報は、  
  ...
  - 出力順序は、下記項目を上から順に出力する
    ...
    25. access_type
    26. language
    27. title_alternative
    28. title_transcription
    29. ncid
    30. ndl_callno
    31. ndl_bibid
    32. jstage_code
...
- 登録済みの雑誌情報：
  - 例：  
    var/instance/static/weko/kbart/WEKO_AllTitles_2021-09-28.txt  
    var/instance/static/weko/kbart/WEKO_AllTitles_2021-09-27.txt
- ログの出力先
