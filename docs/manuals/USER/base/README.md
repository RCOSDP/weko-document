...
1)  ［![icon020010](media/media/image10.png)］ボタンをクリックします。

2)  ログインに成功すると、ホーム画面が表示されます。

<!-- end list -->

6.  Shibbolethで［ログイン］画面からログインします。

Shibbolethでログインする画面は、コンテンツファイルでの設定によって、JAIRO Cloudのログイン画面が表示されます。
...
1)  選択された所属機関のログイン画面に、アカウント情報を入力して、ログインします。
...
![グラフィカル ユーザー インターフェイス 低い精度で自動的に生成された説明](media/media/image302.png)
