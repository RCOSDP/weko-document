...
[15.21 コミュニティタブを編集する 368](#コミュニティタブを編集する)
...
16. ［保存］をクリックします。
    ...
    ［公開日］、［タイトル］、［資源タイプ］はデフォルトのアイテムとして常に表示されています。  
    
    ［公開日］、［タイトル］、［資源タイプ］はオプションの「必須」はチェックありで変更できません。
 
    ［公開日］の「Multiple」は非チェックで変更はできません。
    
    ［タイトル］の「Allow Multiple」はチェックありで変更できません。
...
コミュニティタブを編集する方法を説明します。

1.[設定] をクリックして[コミュニティページ] をクリックします。

　コミュニティタブの編集画面が表示されます。
...
<tr class="odd">
<td>タイトル　(英語)</td>
<td><p>言語は英語に設定してあり、表示したいコミュニティ名を入力します。</p>
<p>コミュニティ名の設定を行わない場合、初期値として設定されている　「Communities」が表示されます。</p>
<p>必須項目の為、このタイトルを未設定にし保存する事はできません。</p></td>
</tr>
<tr class="even">
<td>タイトル　(日本語)</td>
<td><p>言語は日本語に設定してあり、表示したいコミュニティ名を入力します。</p>
<p>コミュニティ名の設定を行わない場合、初期値として設定されている　「コミュニティ」が表示されます。</p>
<p>タイトルの追加ボタンを押下することでフィールドを出現させることが出来ます。</p>
<p>削除ボタンにてテキストボックス自体の削除が可能になっています。</p></td>
</tr>
<tr class="odd">
<td>補足文</td>
<td><p>コミュニティタブに表示するための補足文を入力します。</p>
<p>補足文の設定を行わない場合、初期値として設定されている　「created and curated by WEKO3 users」が表示されます。</p>
<p>削除ボタンにてテキストボックス自体の削除が可能になっています。</p></td>
</tr>
<tr class="even">
    <td>アイコン</td>
    <td>
        <p>コミュニティタブに表示するためのアイコンを入力します。</p>
        <p>初期設定では「fa fa-group」が設定されており、描画ボタンを押下することにより、このようなアイコンを確認することができます。</p>
        <img src="media/media/image425.png" alt="アイコン画像">
    </td>
</tr>
<tr class="odd">
<td>保存</td>
<td>保存ボタンを押下することにより、内容を保存することができます。</td>
</tr>
</tbody>
</table>
...
　アイコンを設定する際「こちらを参照」を押下することにより、以下URLのサイトに遷移しアイコンの設定を検索することができます

　https://fontawesome.com/v4/icons/　

　アイコンのclassが存在しない場合には以下のようなエラーが画面上に出力されます。

![](media/media/image426.png)

344.保存時のエラー

必須項目である英語版のタイトルを空欄のまま保存ボタンを押下すると、このようなエラーが画面上に表示されます。
...
345. ［Institution Name］に文字列を入力します。
...
347. ［アイテムインデックスの再作成］または［アイテムの再インデックス］のどちらかのラジオボタンをクリックします。

![グラフィカル ユーザー インターフェイス, アプリケーション 自動的に生成された説明](media/media/image429.png)
...
![グラフィカル ユーザー インターフェイス, テキスト, アプリケーション, メール 自動的に生成された説明](media/media/image430.png)

349. ［リクエスト］または［招待］をクリックします。
     
     ［保留中のリクエスト］または［保留中の招待］画面が表示されます。

![グラフィカル ユーザー インターフェイス, アプリケーション 自動的に生成された説明](media/media/image431.png)

350. グループに加わる場合は、［同意］をクリックします。
...
![グラフィカル ユーザー インターフェイス, アプリケーション 自動的に生成された説明](media/media/image432.png)

351. 項目を入力します。

![グラフィカル ユーザー インターフェイス, テキスト, アプリケーション 自動的に生成された説明](media/media/image433.png)
...
![zu1205120](media/media/image441.png)
...
![グラフィカル ユーザー インターフェイス, テキスト, アプリケーション, メール 自動的に生成された説明](media/media/image442.png)

360. セッションの有効時間を選択します。
